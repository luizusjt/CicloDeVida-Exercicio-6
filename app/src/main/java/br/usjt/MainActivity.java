...
import br.usjt.LatLongDao;

public class MainActivity extends AppCompatActivity {


    public static final int REQUEST_CODE_GPS = 1001;
    private static long LOCATION_INTERVAL = 2 * 60 * 100;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                LatLongLocalizacao localizacao = new LatLongLocalizacao(location.getLatitude(), location.getLongitude());
